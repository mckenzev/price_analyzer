...
**Формат файла:**
```
В первой строке таблицы должны быть заголовки, среди которых обязательно должен присутствовать столбец с названием
"Наименование товара" (регистр не важен). Под этим столбцом должны быть указаны препараты для анализа.
```
